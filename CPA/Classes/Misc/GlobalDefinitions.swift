...
final class GlobalDefinitions {
    ...
    static let apiKey = "Jh4mUHdWD9Bqjq4a"

    static let sdkDomainUrl = "https://analytics.korrekted.com"
    static let sdkApiKey = "KagTHLarliOf6cYK"

    static let applicationTag = "EXAM_CPA"

    static let amplitudeApiKey = "b503251969f4b1d7901d2f7d1388d476"
    static let appsFlyerApiKey = "DCciCfYXjMQ8QnkdCg8qzk"

    static let appStoreUrl = "https://apps.apple.com/app/cpa-test-exam-prep/id1586581325"
    static let appleAppID = "1586581325"
